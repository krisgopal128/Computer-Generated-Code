...
class SnakeGame:
    ...
    def auto_move(self):
        ...
        # Prioritize directions that move closer to food
        if head_x < food_x:
            possible_directions.insert(0, "Right")
            possible_directions.remove("Left")
        elif head_x > food_x:
            possible_directions.insert(0, "Left")
            possible_directions.remove("Right")
        if head_y < food_y:
            possible_directions.insert(0, "Down")
            possible_directions.remove("Up")
        elif head_y > food_y:
            possible_directions.insert(0, "Up")
